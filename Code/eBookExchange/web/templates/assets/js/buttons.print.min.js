...
(function(b){
    ...
    u.ext.buttons.print={
        ...
        action:function(a,k,p,h){
            ...
            if(a.header.length==10){
                h.header&&(m+="<thead><tr><th></th><th colspan=3>Total</th><th colspan=3>Rural</th><th colspan=3>Urban</th><th></th></tr>"+r(a.header,"th")+"</thead>");
            }else{
                h.header&&(m+="<thead><tr><th></th><th colspan=3>Urban</th><th></th></tr>"+r(a.header,"th")+"</thead>");
            }
            m+="<tbody>";
