<%-- 
    Document   : Pending Exchange Requests
...
<html>
    ...
    <body>
        <h3 style="text-align: center">Pending Exchange Requests</h3>
                                    ...
                                    <tbody>
                                        <c:forEach var="data" items="${exchangeTransactionList}">
                                            <tr> 
                                                ...
                                                <td>
                                                    <a  class="forward fancybox.iframe"  href="showReplyTransactionRequest?exchangeTransactionBean.transaction_id=${data.transaction_id}">Reply</a>
                                                </td>
                                            </tr> 
                                        </c:forEach>
                                    </tbody>
