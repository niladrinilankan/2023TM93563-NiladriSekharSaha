...
<html>
    <head>
        ...
        <title>Place Exchange Request</title>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                        <s:form action="placeExchangeTransactionRequest" theme="simple" method="post" autocomplete="off" enctype="multipart/form-data">
                            <h2 class="form-title" style="color: #13576C; text-align: center; font-weight: bold">Place Exchange Request</h2>  
                            <br/>
                            ...
                            <div class="row g-3 row justify-content-center">
                                <div class="mb-3">
                                    ...
                                    <s:textfield name="exchangeTransactionBean.delivery_method" id="delivery_method" placeholder="Add Delivery Method" cssClass="form-control" theme="simple" />
                                </div>
                                <div class="mb-3">
                                    <label for="title" class="form-label" style="font-weight: bold">Exchange Duration</label>
                                    <s:textfield name="exchangeTransactionBean.exchange_duration" id="exchange_duration" placeholder="Add Duration for Exachnage" cssClass="form-control" theme="simple" />
                                </div>
                                <div class="col-3">
                                    <s:submit  value="Place Exchange Request" cssClass="btn btn-primary"/>
                                </div>
                            </div>
                        </s:form>
                    </div>
