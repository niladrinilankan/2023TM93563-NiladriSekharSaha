                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                        <s:form action="" theme="simple" method="post" enctype="multipart/form-data">
                            ...
                            <h2 class="form-title" style="color: #13576C; text-align: center; font-weight: bold">Confirm OTP and Reset Password</h2>  
                            <br/>
                            <div class="row g-3 row justify-content-center">
                                ...
                                <div class="col-3">
                                    <s:submit action="submitResetPassword" value="Reset" cssClass="btn btn-primary"/>
                                </div>
                            </div>
                        </div>
                    </s:form>
